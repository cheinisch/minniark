...
<html lang="<?php echo get_language(); ?>">
  ...
  <body class="min-h-screen flex flex-col">
          ...
          <div class="flex h-16 justify-between">
            <div class="flex">
              ...
              <div class="hidden md:ml-6 md:flex md:space-x-8">
                ...
                <a href="blog.php" class="inline-flex items-center border-b-2 border-sky-400 px-1 pt-1 text-base font-medium text-sky-400"><?php echo languageString('nav.blogposts'); ?></a>
      ...
      <aside class="hidden md:block max-w-[280px] w-full bg-neutral-200 dark:bg-gray-950 overflow-auto flex-1">   
        <nav class="flex flex-1 flex-col pt-5 px-15 text-gray-600 text-base font-medium" aria-label="Sidebar">
            <ul role="list" class="-mx-2 space-y-1">
              <li>Content</li>
              <ul class="px-5">
                <li><a href="blog.php" class="text-gray-400 hover:text-sky-400">All Posts (<?php echo count_posts(); ?>)</a></li>
              </ul>                  
            </ul>
          </nav>
      </aside>
      <main class="flex-1 bg-white dark:bg-neutral-900 p-6 overflow-auto">          
        <form id="essayForm" action="backend_api/essay_save.php" method="post">
                ...
                <div class="sm:col-span-4">
                  ...
                  <div class="mt-2">
                    <div class="flex items-center bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-sky-600">
                      <input type="text" name="title" id="title" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="title" value="<?php echo $essay['title']; ?>">
                    </div>
                  </div>
                </div>
                <div class="sm:col-span-4">
                  ...
                  <div class="mt-2">
                    <div class="flex items-center bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-sky-600">
                      <div class="shrink-0 text-base text-gray-500 select-none sm:text-sm/6">/userdata/content/essays/</div>
                        <input type="text" name="foldername" id="foldername" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="foldername" readonly value="<?php echo $essay['slug']; ?>">
                  ...
                  <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                      <div class="flex items-center bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-sky-600">
                        <input type="text" name="tags" id="tags" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="tags" value="<?php echo isset($essay['tags']) ? htmlspecialchars(implode(', ', $essay['tags']), ENT_QUOTES, 'UTF-8') : ''; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-span-full">
    ...
    <script>
      ...
      coverUploadForm.addEventListener("submit", async function (e) {
        e.preventDefault();

        const formData = new FormData();
        formData.append("coverFile", document.getElementById("coverFile").files[0]);

        const response = await fetch("./backend_api/upload_cover.php", {
          method: "POST",
          body: formData
        });

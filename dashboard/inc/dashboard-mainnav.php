<a href="dashboard-personal.php" class="block px-4 text-base font-medium text-cyan-500 hover:bg-gray-100 hover:text-gray-800 sm:px-6"><?php echo languageString('dashboard_nav.personalsettings'); ?></a>
<?php
                    
    if($_SESSION['admin'])
    {
        ?>
        <a href="dashboard-user.php" class="block px-4 text-base font-medium text-cyan-500 hover:bg-gray-100 hover:text-gray-800 sm:px-6"><?php echo languageString('dashboard_nav.usersettings'); ?></a>

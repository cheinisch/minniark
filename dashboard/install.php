            ...
            <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 max-w-md bg-neutral-200 dark:bg-gray-900 my-10 m-auto">
                ...
                <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                        <input type="text" name="username" id="username" required class="block w-full bg-white dark:bg-gray-600 px-3 py-1.5 text-base text-gray-900 dark:text-gray-300 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-sky-600 sm:text-sm/6">
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                        <input type="text" name="sitename" id="sitename" required class="block w-full bg-white dark:bg-gray-600 px-3 py-1.5 text-base text-gray-900 dark:text-gray-300 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-sky-600 sm:text-sm/6">
                        </div>
                    </div>

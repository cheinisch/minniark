document.addEventListener('DOMContentLoaded', () => {
    const dropdownButton = document.querySelector('[aria-haspopup="listbox-type"]');
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const dropdownButton = document.querySelector('[aria-haspopup="listbox-page"]');
    const dropdownList = dropdownButton.nextElementSibling;
    const dropdownItems = dropdownList.querySelectorAll('[role="option"]');
    const display = dropdownButton.querySelector('span');
  ...
  document.addEventListener('DOMContentLoaded', () => {
    const dropdownButton = document.querySelector('[aria-haspopup="listbox-album"]');
    const dropdownList = dropdownButton.nextElementSibling;
    const dropdownItems = dropdownList.querySelectorAll('[role="option"]');
    const display = dropdownButton.querySelector('span');

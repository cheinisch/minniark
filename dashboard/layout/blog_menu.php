<ul role="list" class="flex flex-1 flex-col gap-y-7">
						...
						<li>
							<div class="text-xs/6 font-semibold text-gray-400"><?php echo languageString('blog.filter_posts'); ?></div>
							<ul role="list" class="-mx-2 mt-2 space-y-1">
									...
									<span class="truncate"><?php echo languageString('blog.reset_filter'); ?></span>
									</a>
								</li>
								<li>
									<button type="button"
										...
										<span class="flex-1 text-left"><?php echo languageString('blog.year'); ?></span>
										<!-- Chevron -->
								...
								<li>
									<button type="button"
										...
										<span class="flex-1 text-left"><?php echo languageString('blog.tags'); ?></span>
										<!-- Chevron -->
										<svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"
											class="size-5 shrink-0 transition-transform duration-200" data-chevron>
										<path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 0 1 1.06.02L10 10.94l3.71-3.71a.75.75 0 1 1 1.06 1.06l-4.24 4.25a.75.75 0 0 1-1.06 0L5.25 8.29a.75.75 0 0 1-.02-1.08z" clip-rule="evenodd" />

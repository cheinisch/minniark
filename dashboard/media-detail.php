...
<script
  src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js">
	...
	<body class="bg-white dark:bg-black">
		...
		<el-dialog>
  <div id="editImageTextModal"
       class="hidden fixed inset-0 z-50"
       role="dialog" aria-modal="true" aria-labelledby="image-text-dialog">
    ...
    <div tabindex="0" class="flex min-h-full items-end justify-center p-4 text-center focus:outline-none sm:items-center sm:p-0">
      <el-dialog-panel
        ...
        <div class="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
          <button type="button"
                  command="close" commandfor="editImageTextModal"
...
<el-dialog>
  <div id="editExifModal"
       class="hidden fixed inset-0 z-50"
       role="dialog" aria-modal="true" aria-labelledby="exif-edit-dialog">
    ...
    <div tabindex="0" class="flex min-h-full items-end justify-center p-4 text-center focus:outline-none sm:items-center sm:p-0">
      <el-dialog-panel
        ...
        <div class="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
          <button type="button"
                  id="editExifClose"
                  command="close" commandfor="editExifModal"
                  class="rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-2 focus:outline-offset-2 focus:outline-cyan-600
                         dark:bg-black dark:hover:text-gray-300 dark:focus:outline-white">
            <span class="sr-only">Close</span>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true" class="size-6">
        ...
        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
          ...
          <button type="button" id="cancel_metadata"
                  command="close" commandfor="editExifModal"
      ...
      <el-dialog-panel
        ...
        <div class="sm:flex sm:items-start">
          <div class="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-red-100
                      sm:mx-0 sm:size-10 dark:bg-red-500/10">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
          ...
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <h3 id="ai-dialog" class="text-base font-semibold text-gray-900 dark:text-white">
        ...
        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
          ...
          <button type="button"
                  ...
                  class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2
                         text-sm font-semibold text-white shadow-xs hover:bg-red-500
          ...
          <a href="backend_api/ai_img_text.php?file=<?php echo urlencode($image_url); ?>"
             class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2
                    text-sm font-semibold text-gray-900 shadow-xs inset-ring-1 inset-ring-gray-300

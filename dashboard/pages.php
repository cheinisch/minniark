        ...
        <nav class="bg-neutral-200 dark:bg-gray-950 shadow-sm">
                    ...
                    <div class="flex items-center">
                      <div class="shrink-0">
                        <a href="page-detail.php?post=new">
                          <button type="button" class="relative inline-flex items-center gap-x-1.5 rounded-md bg-sky-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-sky-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">
                ...
                <div class="md:hidden" id="mobile-menu">
                  <div class="space-y-1 pt-2 pb-3">
                    ...
                    <a href="blog.php" class="block border-l-4 border-sky-500 py-2 pr-4 pl-3 text-base font-medium text-sky-500 sm:pr-6 sm:pl-5">Blogposts</a>
          ...
          <aside class="hidden md:block max-w-[280px] w-full bg-neutral-200 dark:bg-gray-950 overflow-auto flex-1">
            <nav class="flex flex-1 flex-col pt-5 px-15 text-gray-600 text-base font-medium" aria-label="Sidebar">
                <ul role="list" class="-mx-2 space-y-1">
                  <li>Content</li>
                  <ul class="px-5">
                    <li><a href="?" class="text-gray-400 hover:text-sky-500">All Posts (<?php echo count_pages(); ?>)</a></li>
                  </ul>
                  <li>Year</li>
                  <ul class="px-5">

        ...
        <nav class="bg-neutral-200 dark:bg-gray-950 shadow-sm">
                  ...
                  <div class="flex h-16 justify-between">
                    <div class="flex">
                      ...
                      <div class="hidden md:ml-6 md:flex md:space-x-8">
                        ...
                        <a href="dashboard.php" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-base font-medium text-gray-600 dark:text-gray-300 hover:border-sky-500 hover:text-sky-500"><?php echo languageString('nav.dashboard'); ?></a>
                        <a href="media.php" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-base font-medium text-gray-600 dark:text-gray-300 hover:border-sky-500 hover:text-sky-500"><?php echo languageString('nav.images'); ?></a>
                        <a href="blog.php" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-base font-medium text-gray-600 dark:text-gray-300 hover:border-sky-500 hover:text-sky-500"><?php echo languageString('nav.blogposts'); ?></a>
                        <a href="pages.php" class="inline-flex items-center border-b-2 border-sky-500 px-1 pt-1 text-base font-medium text-sky-500"><?php echo languageString('nav.pages'); ?></a>
                      </div>
                    </div>
                ...
                <div class="md:hidden" id="mobile-menu">
                  <div class="space-y-1 pt-2 pb-3">
                    ...
                    <a href="pages.php" class="block border-l-4 border-sky-500 py-2 pr-4 pl-3 text-base font-medium text-sky-500 sm:pr-6 sm:pl-5"><?php echo languageString('nav.pages'); ?></a>
                  </div>
                  <div class="border-t border-gray-500 pt-4 pb-3">
                    <div class="mt-3 space-y-1">
                      ...
                      <div class="pl-5">
                        <a href="?" class="block px-4 py-2 text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 sm:px-6">Pages (<?php echo count_pages(); ?>)</a>
                      </div>
                    </div>
                  </div>
                  <div class="border-t border-gray-500 pt-4 pb-3">
          ...
          <aside class="hidden md:block max-w-[280px] w-full bg-neutral-200 dark:bg-gray-950 overflow-auto flex-1">
            <nav class="flex flex-1 flex-col pt-5 px-15 text-gray-600 text-base font-medium" aria-label="Sidebar">
                <ul role="list" class="-mx-2 space-y-1">
                  <li>Content</li>
                  <ul class="px-5">
                    <li><a href="?" class="text-gray-400 hover:text-sky-500">All Pages (<?php echo count_pages(); ?>)</a></li>
                  </ul>
                  <li>Year</li>
                  <ul class="px-5">
      ...
      <div class="mt-16 space-y-20 lg:mt-20 lg:space-y-20">
        ...
        <article class="relative isolate flex flex-col gap-8 lg:flex-row">
          <div class="relative aspect-video sm:aspect-2/1 lg:aspect-square lg:w-64 lg:shrink-0">
            <img src="<?php echo $page['cover']; ?>" alt="" class="absolute inset-0 size-full bg-gray-50 object-cover">
          ...
          <div>
            ...
            <div class="group relative max-w-5xl">
              ...
              <p class="mt-5 text-sm/6 text-gray-600"><?php echo $page['content']; ?></p>
            </div>
          </div>
        </article>
        <?php } ?>

...
error_reporting(E_ALL);
    ...
    function get_pages($year = null, $tag = null)
    {
    ...
    function get_pageyearlist($mobile)
    {
        $baseDir = __DIR__ . '/../../userdata/content/pages/';
        $yearCounts = [];
        ...
        foreach ($yearCounts as $year => $count) {
            if ($mobile) {
                echo "<div class=\"pl-5\">
                    <a href=\"pages.php?year=$year\" class=\"block px-4 text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 sm:px-6\">$year ($count)</a>
                </div>\n";
            } else {
                echo "<li><a href=\"pages.php?year=$year\" class=\"text-gray-400 hover:text-sky-400\">$year ($count)</a></li>\n";
            }
        }
    }

    function read_page($foldername) {
